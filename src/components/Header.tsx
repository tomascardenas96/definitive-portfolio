...
const Header = ({ session }: { session: Session | null }) => {
  ...
  return (
    <nav className="flex h-[100%] rounded-t-2xl items-center justify-center bg-[#10151e] left-0 w-full border-t border-[#4747476f] max-w-[28.25rem] justify-self-center select-none xl:hidden">
