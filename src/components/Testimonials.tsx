...
function Testimonials({ session }: { session: Session | null }) {
  ...
  return (
    <div className="grid grid-rows-[5.5rem_1fr] xl:grid-rows-[4.5rem_1fr] 2xl:grid-rows-[5.5rem_1fr] container-header-xmd">
      ...
      <div className="grid grid-rows-[1fr_3.5rem] px-1 gap-4 mt-1 max-h-[21.5rem] overflow-hidden xl:h-[calc(44vh-5.5rem)] xl:min-h-[16.4rem] xl:max-h-[20rem] xl:grid-rows-[1fr_3rem] 2xl:min-h-[15.875rem]">
        <div
          className="flex flex-col overflow-y-auto gap-3 px-4 mt-2 xl:scrollbar-thin xl:scrollbar-thumb-[#ffffff48] xl:scrollbar-track-[transparent]"
          ref={scrollRef}
        >
          {!isLoading ? (
