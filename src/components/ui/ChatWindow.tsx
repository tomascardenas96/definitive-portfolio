function ChatWindow({
  ...
  return (
    ...
    >
      <div className="border-b border-b-[var(--container-border)] px-5 grid items-center">
        <div className="grid items-center h-[2.3rem] gap-2 grid-cols-[2.5rem_1fr_max-content]">
          <div className="w-[2.3rem] h-[2.3rem] bg-amber-900 rounded-[.4rem]"></div>
